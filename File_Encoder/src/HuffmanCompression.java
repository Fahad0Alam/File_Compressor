...
public class HuffmanCompression{
    ...
    private static byte[] zipBytesWithCodes(byte[] bytes,Map<Byte,String> huffCodes){
        ...
        byte[] huffCodesBytes = new byte[length];
        int idx = 0;
        for(int i=0;i<strBuilder.length();i +=8){
            ...
            huffCodesBytes[idx] = (byte) Integer.parseInt(strByte,2);
            idx++;
        }
        return huffCodesBytes;
    }
    ...
    public static void main(String[] args){
        compress("C:\\Users\\PC\\Desktop\\para.txt", "C:\\Users\\PC\\Desktop\\compressed.txt");
    }
}
